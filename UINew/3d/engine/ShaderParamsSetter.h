...
public:
    ...
    //
    void setSpecularPower(uint idUniform);
    void setCameraRightWS(uint idUniform);
    void setCameraUpWS(uint idUniform);
    void setMaterialColor(uint idUniform);
    void setObjectIndex(uint idUniform);
